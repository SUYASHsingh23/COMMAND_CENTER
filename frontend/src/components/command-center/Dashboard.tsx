...
function Resizer({
  ...
  return (
    <div
      ...
      title={title || 'Drag to resize sidebar, double click to toggle'}
      style={{
        width: 8,
        cursor: 'col-resize',
...
export function CommandCenter() {
  ...
  // Sidebar resizable and collapsible state
    ...
    <div style={{
      ...
      {isSidebarCollapsed ? (
        <div
          ...
          title="Click to expand Call Sessions sidebar"
          style={{
            width: 38,
            flexShrink: 0,
        ...
        <>
          ...
          <Resizer
            ...
            title="Drag to resize sidebar (double click to minimize)"
          />
        </>
      )}
